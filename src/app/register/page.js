            ...
            <form className="w-full max-w-sm">
                <div className="md:flex md:items-center mb-6">
                    <div className="md:w-1/3">
                        <htmlFor className="block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4" for="inline-full-name">
                            Full Name
                        </htmlFor>
                    </div>
                ...
                <div className="md:flex md:items-center mb-6">
                    <div className="md:w-1/3">
                        <htmlFor className="block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4" for="inline-password">
                            Password
                        </htmlFor>
                    </div>
                    <div className="md:w-2/3">
                ...
                <div className="md:flex md:items-center mb-6">
                    ...
                    <htmlFor className="md:w-2/3 block text-gray-500 font-bold">
